...
Widget buildVenueItem(Map<String, dynamic> item) {
  ...
  children: [
    Image.asset(
      ...
      width: 16,
      height: 16,
      color: Design.lightGrey, // Optional: if your image is an icon and you want to tint it
    ),
  ...
  TextSpan(
    children: [
      TextSpan(
        text: '$greeting, ',
        style: const TextStyle(
          fontSize: Design.font15, // reduced size
      ...
      TextSpan(
        ...
        style: const TextStyle(
          fontSize: Design.font15, // same reduced size
    ...
    children: [
      ...
      TextSpan(
        ...
        style: const TextStyle(
          ...
          color: Design.primaryColorOrange, // or any color you like
        ),
      ),
    ],
  ),
