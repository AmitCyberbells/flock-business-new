...
class _OpenHoursScreenState extends State<OpenHoursScreen> {
 ...
 final List<Map<String, dynamic>> _baseDays = [
   {"day": "Mon", "isOpen": false, "openTime": "12:00 AM", "closeTime": "12:00 AM", "updated": false},
   {"day": "Tue", "isOpen": false, "openTime": "12:00 AM", "closeTime": "12:00 AM", "updated": false},
   {"day": "Wed", "isOpen": false, "openTime": "12:00 AM", "closeTime": "12:00 AM", "updated": false},
   {"day": "Thu", "isOpen": false, "openTime": "12:00 AM", "closeTime": "12:00 AM", "updated": false},
   {"day": "Fri", "isOpen": false, "openTime": "12:00 AM", "closeTime": "12:00 AM", "updated": false},
   {"day": "Sat", "isOpen": false, "openTime": "12:00 AM", "closeTime": "12:00 AM", "updated": false},
   {"day": "Sun", "isOpen": false, "openTime": "12:00 AM", "closeTime": "12:00 AM", "updated": false},
 ];
   ...
   try {
     ...
     if (response.statusCode == 200) {
       ...
       if (data['status'] == 'success' && data['data'] != null) {
         ...
         List<Map<String, dynamic>> updatedDays = _baseDays.map((e) => Map<String, dynamic>.from(e)).toList();
 ...
 Future<void> _saveOpeningHours() async {
   ...
   for (int i = 0; i < _days.length; i++) {
     ...
     final String closeT = d["isOpen"] ? d["closeTime"].toString() : "12:00 AM";
 ...
 String _convertTo12HrFormat(String time24) {
   try {
     if (time24.toLowerCase().contains('am') || time24.toLowerCase().contains('pm')) {
       return time24;
     }
           ...
           SizedBox(
             ...
             child: Container(
               ...
               child: Switch(
                 ...
                 activeColor: dayInfo["updated"] == true ? Colors.green : Colors.orange,
                 onChanged: (value) {
                   setState(() {
